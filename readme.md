...
- После создания и редактирования объявления отправляем его в очередь на модерацию
- Сохраняем историю последних просмотренных объявлений для формирования рекомендаций
- Загруженные изображения товаров/услуг сжимаем для эффективного хранения
...
- Профиль (**1** профиль на пользователя)
...
| Создание отзыва о продавце/покупателе | 0.2 | 345.6 тыс | 4 |
| Просмотр отзывов о продавце/покупателе | 14 | 23.8 млн | 276 |
...
- Поиск товара/услуги: будем считать, что каждый пользователь из DAU в среднем делает **7** поисковых запрсов, поэтому всего таких запросов будет приходить **11.9 млн** в сутки
...
| Создание отзыва о продавце/покупателе | 4 Кб | 0.0001 | 0.001 |
| Просмотр отзывов о продавце/покупателе | 176 Кб | 0.39 | 4.29 |
| Отправка сообщения в чате | 2 Кб | 0.006 | 0.059 |
| Получение сообщения в чате | 2 Кб | 0.006 | 0.059 |

###### Итог

- Суммарное пиковое потребление: **3.26 Гбит/сек**
