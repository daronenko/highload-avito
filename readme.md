...
Распределять запросы внтури страны будем с помощью BGP Anycast, что позволит балансировать нагрузку и отправлять пользователей на необходимые дата-центры.
