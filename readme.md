...
| - | :-: | :-: | :-: |
| Создание объявления | 0.7 | 1.4M | 16 |
| Редактирование объявления | 6 | 13.6M | 157 |
| Поиск товара/услуги | 7 | 137.6M | 1592 |
| Получение рекомендаций | 5 | 124M | 1435 |
| Просмотр объявления | 10 | 248M | 2870 |
| Создание отзыва о продавце/покупателе | 0.001 | 34.6K | 0.4 |
| Просмотр отзывов о продавце/покупателе | 2 | 49.6M | 574 |
| Отправка сообщения в чате | 7 | 160M | 1852 |
| Получение сообщения в чате | 7 | 160M | 1852 |
...
| **Действие** | **Трафик на одно действие, Кб** | **Пиковое потребление, Гбит/сек** | **Суммарный суточный трафик, Тбайт/сутки** |
| - | :-: | :-: | :-: |
| Создание объявления | 6144 Кб | 0.81 | 8.70 |
| Редактирование объявления | 307 Кб | 0.40 | 4.26 |
| Поиск товара/услуги | 474 Кб | 6.2 | 66.76 |
| Получение рекомендаций | 350 Кб | 4.1 | 44.44 |
| Просмотр объявления | 214 Кб | 5.0 | 54.34 |
| Создание отзыва о продавце/покупателе | 3 Кб | 0.00001 | 0.0001 |
| Просмотр отзывов о продавце/покупателе | 176 Кб | 0.83 | 8.94 |
| Отправка сообщения в чате | 1 Кб | 0.002 | 0.16 |
| Получение сообщения в чате | 1 Кб | 0.002 | 0.16 |

###### Итог

- Суммарное пиковое потребление: **17.34 Гбит/сек**
