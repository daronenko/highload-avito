...
| Запрос | Москва | Санкт-Петербург | Ростов-на-Дону | Иркутск |
| - | :-: | :-: | :-: | :-: |
...
Распределять запросы внтури страны будем с помощью BGP Anycast, что позволит балансировать нагрузку по дата-центрам и отправлять пользователей на необходимые дата-центры.
